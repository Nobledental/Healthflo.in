...
export default function Navbar() {
  return (
    <nav className="fixed top-0 left-0 right-0 w-full border-b border-[#eef0f2] flex items-center px-8 py-4 justify-between z-50 bg-white/50 backdrop-blur-md h-16 shadow-sm">
